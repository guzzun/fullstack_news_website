			...
			<div class="container">
				<div class="content_inner">
					...
					if ($_SESSION['user_role'] == 3) {
						...
						$query = "SELECT * FROM inbox ORDER BY data DESC";
						$result = mysqli_query($conn, $query);
						
						
						if ($result) {
							echo '<div class="table_dash">';
							echo '<h3 class="users_display">Inbox pagina contacte</h3>';
							...
							while ($row = mysqli_fetch_assoc($result)) {
								...
								echo '<td class="action_styles">
                                            <a href="atmin/delete_row.php?inbox=' . $row['id'] . '" class="link">
